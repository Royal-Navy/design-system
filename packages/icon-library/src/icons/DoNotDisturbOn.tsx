...
const SvgDoNotDisturbOn = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="do-not-disturb-on_svg__b" fill="#fff">
        <use xlinkHref="#do-not-disturb-on_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#do-not-disturb-on_svg__b)">
