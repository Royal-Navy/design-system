...
const SvgLocationSearching = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="location-searching_svg__b" fill="#fff">
        <use xlinkHref="#location-searching_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#location-searching_svg__b)">
