...
const SvgRemoveRedEye = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="remove-red-eye_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="remove-red-eye_svg__b" fill="#fff">
        <use xlinkHref="#remove-red-eye_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#remove-red-eye_svg__b)">
