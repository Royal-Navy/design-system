...
const SvgDriveEta = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="drive-eta_svg__b" fill="#fff">
        <use xlinkHref="#drive-eta_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#drive-eta_svg__b)">
