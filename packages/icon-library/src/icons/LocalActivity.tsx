...
const SvgLocalActivity = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="local-activity_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="local-activity_svg__b" fill="#fff">
        <use xlinkHref="#local-activity_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#local-activity_svg__b)">
