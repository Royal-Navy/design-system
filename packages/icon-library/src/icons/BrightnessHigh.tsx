...
const SvgBrightnessHigh = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="brightness-high_svg__b" fill="#fff">
        <use xlinkHref="#brightness-high_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#brightness-high_svg__b)">
