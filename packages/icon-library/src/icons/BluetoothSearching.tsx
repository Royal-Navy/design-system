...
const SvgBluetoothSearching = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="bluetooth-searching_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="bluetooth-searching_svg__b" fill="#fff">
        <use xlinkHref="#bluetooth-searching_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#bluetooth-searching_svg__b)">
