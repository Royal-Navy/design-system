...
const SvgStayCurrentLandscape = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="stay-current-landscape_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="stay-current-landscape_svg__b" fill="#fff">
        <use xlinkHref="#stay-current-landscape_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#stay-current-landscape_svg__b)">
