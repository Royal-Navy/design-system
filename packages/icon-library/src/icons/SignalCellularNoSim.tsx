...
const SvgSignalCellularNoSim = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="signal-cellular-no-sim_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="signal-cellular-no-sim_svg__b" fill="#fff">
        <use xlinkHref="#signal-cellular-no-sim_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#signal-cellular-no-sim_svg__b)">
