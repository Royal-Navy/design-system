...
const SvgBrightness5 = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="brightness-5_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="brightness-5_svg__b" fill="#fff">
        <use xlinkHref="#brightness-5_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#brightness-5_svg__b)">
