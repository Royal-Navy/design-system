...
const SvgLocalPhone = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="local-phone_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="local-phone_svg__b" fill="#fff">
        <use xlinkHref="#local-phone_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#local-phone_svg__b)">
