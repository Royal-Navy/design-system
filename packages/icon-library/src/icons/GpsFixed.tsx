...
const SvgGpsFixed = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="gps-fixed_svg__b" fill="#fff">
        <use xlinkHref="#gps-fixed_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#gps-fixed_svg__b)">
