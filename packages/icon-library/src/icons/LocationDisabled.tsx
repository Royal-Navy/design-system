...
const SvgLocationDisabled = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="location-disabled_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="location-disabled_svg__b" fill="#fff">
        <use xlinkHref="#location-disabled_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#location-disabled_svg__b)">
