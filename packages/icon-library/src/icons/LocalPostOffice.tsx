...
const SvgLocalPostOffice = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="local-post-office_svg__b" fill="#fff">
        <use xlinkHref="#local-post-office_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#local-post-office_svg__b)">
