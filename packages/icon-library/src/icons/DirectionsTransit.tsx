...
const SvgDirectionsTransit = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="directions-transit_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="directions-transit_svg__b" fill="#fff">
        <use xlinkHref="#directions-transit_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#directions-transit_svg__b)">
