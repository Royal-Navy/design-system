...
const SvgSettingsInputComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="settings-input-component_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="settings-input-component_svg__b" fill="#fff">
        <use xlinkHref="#settings-input-component_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#settings-input-component_svg__b)">
