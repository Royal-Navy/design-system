...
const SvgLocalGroceryStore = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="local-grocery-store_svg__b" fill="#fff">
        <use xlinkHref="#local-grocery-store_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#local-grocery-store_svg__b)">
