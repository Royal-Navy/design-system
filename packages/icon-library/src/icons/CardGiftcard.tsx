...
const SvgCardGiftcard = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={16} {...props}>
    <defs>
      <path
        id="card-giftcard_svg__a"
    ...
    <g fill="none" fillRule="evenodd">
      <mask id="card-giftcard_svg__b" fill="#fff">
        <use xlinkHref="#card-giftcard_svg__a" />
      </mask>
      <g fill="CurrentColor" mask="url(#card-giftcard_svg__b)">
