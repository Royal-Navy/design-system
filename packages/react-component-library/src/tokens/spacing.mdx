...
<table style={{ width: '100%' }}>
  ...
  <tbody>
    <tr>
      <td>
        <SpacingSwatch backgroundColor="#c74c2e" /> Red
      </td>
      <td>4rem</td>
      <td>`spacing('15')`</td>
    ...
    <tr>
      <td>
        <SpacingSwatch backgroundColor="#cf6349" /> Orange
      </td>
      <td>3rem</td>
      <td>`spacing('14')`</td>
      <td>
        Spacing between elements, above and below dividing lines and titles
      </td>
    </tr>
    <tr>
      <td>
        <SpacingSwatch backgroundColor="#eccc67" /> Yellow
      </td>
      <td>2rem</td>
      <td>`spacing('12')`</td>
      <td>
    ...
    <tr>
      <td>
        <SpacingSwatch backgroundColor="#a5d497" /> Green
      </td>
      <td>1rem</td>
      <td>`spacing('8')`</td>
    ...
    <tr>
      <td>
        <SpacingSwatch backgroundColor="#62aeea" /> Blue
      </td>
      <td>0.5rem</td>
      <td>`spacing('4')`</td>
      <td>
        In rare cases where a full rem is too much such as between tab options
      </td>
    </tr>
  </tbody>
</table>
