...
describe('DatePicker', () => {
        ...
        describe('and the day/month use two digit format', () => {
          ...
          describe('and the tab key is pressed', () => {
            ...
            describe('and the space key is pressed', () => {
              ...
              it('focuses the first day in the picker', () => {
                expect(
                  wrapper.getByRole('gridcell', { name: '1' })
                ).toHaveFocus()
              })
  ...
  describe('when a single date picker with a value is rendered and the picker is opened', () => {
    ...
    it('focuses the initially selected date', () => {
  ...
  describe('when the `disabledDays` prop is provided', () => {
    ...
    it('applies the disabled modifier class to the correct days', () => {
      expect(wrapper.getByText('12')).toHaveClass('rdp-day_disabled')
    })
