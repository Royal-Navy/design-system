...
###### 9.0 You _should_ mark all optional fields with “(optional)” appended to their label. Eg. “Notes (optional)”.

###### 9.1 You _should not_ mark mandatory fields. All fields are mandatory, unless marked as optional.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Service temporarily unavailable (server error 503). Your form was not
        sent.
        <br />
    ...
    <tr>
      <td>Incorrect ID.</td>
      <td>
        Valid ID numbers start with the letter K, followed by a 9-digit number.
      </td>
    </tr>
  </tbody>
</table>
