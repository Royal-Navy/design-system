...
###### 5.0 You _must_ always consider the context of use before deciding which techniques to use for managing long forms.

###### 5.1 You _should_ test a working version of the form with your users, where possible.
...
###### 6.0 You _must_ ensure your form tab order works correctly and follows your intended form layout.
...
<img
  src="/sample_two_column_with_fieldsets.svg"
  alt="two column layout with fieldsets"
/>
...
<img
  src="/sample_destructive_action.svg"
  alt="Destructive action confirmation pattern"
/>
