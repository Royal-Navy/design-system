<template lang="html">
  <div class="rn-transfer">
    ...
    <div class="transfer-buttons">
      <span class="transfer-buttons__button" @click="to_left"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10">
  <g fill="#fff" fill-rule="evenodd" transform="translate(0 .199)">
    ...
    <polygon points="4.548 9.095 0 4.548 4.548 0 5.969 1.421 2.842 4.548 5.969 7.674" transform="rotate(0 2.984 4.548)"/>
      ...
      <span class="transfer-buttons__button" @click="to_right"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10">
  <g fill="#fff" fill-rule="evenodd" transform="translate(0 .199)">
